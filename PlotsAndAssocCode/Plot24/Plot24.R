...
runFunc = function() {
	dw = 1000
	dh = 750	
	path = "D:/Code/R/LeastSquaresPlay/PlotsAndAssocCode/Plot24/"
	f = fitLineGradientDescentVsOthers	
	numPts = 50; width=1200; height = 1200	
	subTitle = "Various Learn Rates"
	savePngVerbose( paste( path, "Plot24.png", sep="" ), f, w=width, h=height, un="px", nIter=20, learnRate=0.5, nPts=numPts, subTitle=subTitle )
}
