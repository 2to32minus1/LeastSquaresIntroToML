...
runFunc = function() {
	dw = 1000
	dh = 750	
	path = "D:/Code/R/LeastSquaresPlay/PlotsAndAssocCode/Plot26/"
	f = fitLineGradientDescentVsOthers	
	numPts = 50; width=1200; height = 1200	
	subTitle = "Various # Iterations"
	savePngVerbose( paste( path, "Plot26.png", sep="" ), f, w=width, h=height, un="px", nIter=100, learnRate=0.05, nPts=numPts, subTitle=subTitle )
}
