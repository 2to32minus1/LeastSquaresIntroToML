...
runFunc = function() {
	dw = 1000
	dh = 750	
	path = "D:/Code/R/LeastSquaresPlay/PlotsAndAssocCode/Plot28/"
	f = fitLineGradientDescentVsOthers	
	numPts = 50; width=1200; height = 1200	
	subTitle = "Various # Iterations"
	savePngVerbose( paste( path, "Plot28.png", sep="" ), f, w=height, h=height, un="px", nIter=500, learnRate=0.2, nPts=numPts, drawContourPlot=TRUE )
}
