...
runFunc = function() {
	dw = 1000
	dh = 750	
	path = "D:/Code/R/LeastSquaresPlay/PlotsAndAssocCode/Plot29/"
	
	savePngVerbose( paste(path, "Plot29.png", sep=""), plotNthOrderPolyToLinearData,   w=dw, h=dw, un="px", N=1, doPlot=TRUE )
}
