...
runFunc = function() {
	dw = 1000
	dh = 750	
	path = "D:/Code/R/LeastSquaresPlay/PlotsAndAssocCode/Plot49/"
	savePngVerbose( paste(path, "Plot49.png", sep=""), plotGaussianParamStepVectors, w=1200, h=1280, un="px", nLevels=120 )
}
